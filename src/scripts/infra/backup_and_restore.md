...
export PG_BACKUPS_S3_BUCKET=$PG_BACKUPS_S3_BUCKET
export PG_CLUSTER_ID=cnpg-cluster-001
export PG_SERVER_NAME=default-server-1
...
export PG_BACKUPS_S3_BUCKET=$PG_BACKUPS_S3_BUCKET
export PG_CLUSTER_ID=cnpg-cluster-001
export RESTORE_SOURCE_SERVER_NAME=default-server-1
